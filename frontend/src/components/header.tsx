...
export default function Header ({setUpdateDisplayInfo,setSearchText, setLoadingDisplayIsTrue }: HeaderProps){
  ...
  return(
    <section className="p-4 w-[85%] left-[15%] fixed z-20 flex justify-center bg-[#0F0D13] border-b-[1px] border-[#555257]">
      <div className="flex relative w-[500px]">
        ...
        <Input handleSearchInput={handleSearchInput} placeholder={"Busca"} formatPadding={"search"}/>
          <div className="pl-4 absolute right-2 border-l-2 border-[#656565] text-[2rem] text-white top-[50%] -translate-y-[50%]">
            <span className="group">
              <VscAccount 
                onClick={()=>showOrNotModal(true, DisplayInfoTypes.SONG)}
